        ...
        <div className="bg-white rounded-[10px] border border-[#d4e4ff] shadow-sm mb-6 overflow-hidden">
          ...
          <div className="bg-[#f2f7ff] border-b border-[#d4e4ff] px-2 py-2 flex flex-wrap justify-between items-center gap-3">
            ...
            <div className="flex items-center flex-wrap gap-2 pr-1">
                <div className="text-xs text-blue-900 font-semibold px-2.5 py-1.5 bg-white border border-[#d4e4ff] rounded-[6px] shadow-sm whitespace-nowrap">
                  Total: {filteredApplications.length}
                </div>

                <div className="w-[1px] h-5 bg-[#d4e4ff] mx-0.5 hidden sm:block"></div>
...
// Ensure the "Reset Filters" button gets the primary button active color
