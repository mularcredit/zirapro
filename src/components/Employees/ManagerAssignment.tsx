                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <div className="relative min-w-[200px]">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-10 pr-8 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500/20 focus:border-green-500 outline-none transition-all appearance-none bg-gray-50/50 cursor-pointer"
                                        >
                                            {locations.map(loc => (
