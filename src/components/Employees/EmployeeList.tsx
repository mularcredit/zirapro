      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentEmployees.map((employee, index) => (
          <motion.div
            ...
            className="group flex flex-col bg-white rounded-2xl border border-gray-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] hover:border-green-500/20 transition-all duration-300 overflow-hidden"
          ...
          >
            {/* Header Section */}
            <div className="relative px-5 py-5 pb-4 bg-gradient-to-br from-white via-white to-gray-50/50">
