                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 border-r border-gray-300">
                                <div className="text-sm font-semibold text-gray-900">{app["Full Name"]}</div>
                              ...
                              {/* Date */}
                              <td className="px-4 py-3 border-r border-gray-300 text-xs text-gray-600">
                                <div className="font-medium text-gray-900">{appDate.toLocaleDateString('en-KE', { day: '2-digit', month: 'short', year: 'numeric' })}</div>
                                <div>{appDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</div>
                              </td>
